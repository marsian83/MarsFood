...
function showContentC(el){
    ...
    function helpShowRestaurents(){
        ...
        document.getElementById("list-item1").style.backgroundColor="var(--background)";
        document.getElementById("list-item2").style.backgroundColor="rgb(232, 232, 232)";
    ...
    function helpShowCustomers(){
        ...
        document.getElementById("list-item2").style.backgroundColor="var(--background)";
        document.getElementById("list-item1").style.backgroundColor="rgb(232, 232, 232)";
    }
